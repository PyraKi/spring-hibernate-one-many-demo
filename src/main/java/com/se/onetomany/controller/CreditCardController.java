...
public class CreditCardController {
    ...
    public String saveCreditCard(Model theModel, @ModelAttribute("creditCardAttribute") CreditCard theCard,
    ...
    public String updateCreditCard(Model theModel, @ModelAttribute("creditCardAttribute") CreditCard theCard,
            @RequestParam("personId") int personId) {
        // save the customer using our service
    ...
    @GetMapping("/delete")
    public String deleteCreditCard(Model theModel,
            @RequestParam("creditCardId") int theId, @RequestParam("personId") int personId) {
